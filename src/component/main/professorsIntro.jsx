      ...
      <Grid>
        ...
        <Col xs={14} md={10}>
            <div className="professorsIntroBlock">
                ...
                <Jumbotron>
                    <Row>
                        <div className="agreementH1">Professor Neal Pilson</div>
                        <div className="agreementH2">皮尔森导师</div>
                    </Row>
                    <Row>
                        <Col xs={4} md={3}>
                ...
                <Jumbotron>
                    <Row>
                        <div className="agreementH1">Professor William D. Squires</div>
                        <div className="agreementH2">斯科尔斯导师</div>
                    </Row>
                    <Row>
                        <Col xs={4} md={3}>
                        ...
                        <Col xs={12} md={9}>
                            <ListGroup componentClass="ul">
                                <li className="pgraph">哥伦比亚大学体育管理硕士项目教授</li>
                                <li className="pgraph">美国场馆协会主席（1991年至2010年）</li>
                                <li className="pgraph">The Right Stuff 咨询公司创始人</li>
                                <li className="pgraph">Super Bowl超级碗场馆运营负责人</li>
                            </ListGroup>
                        </Col>
                    </Row>
                    <Row>
                ...
                <Jumbotron>
                    <Row>
                        <div className="agreementH1">Professor Ray Katz</div>
                        <div className="agreementH2">卡茨导师</div>
                    </Row>
                    <Row>
                        <Col xs={4} md={3}>
                        ...
                        <Col xs={12} md={9}>
                            <ListGroup componentClass="ul">
                                <li className="pgraph">哥伦比亚大学体育管理硕士项目教授</li>
                                <li className="pgraph">ROI Sports Group源体育合伙人</li>
                                <li className="pgraph">沃顿体育产业项目咨询顾问</li>
                            </ListGroup>
                        </Col>
                    </Row>
                    <Row>
