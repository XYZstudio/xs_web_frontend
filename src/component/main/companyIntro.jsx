    ...
    return (
      <Grid>
        ...
        <Col xs={14} md={10}>
          ...
          &nbsp;&nbsp;
          <div className="pgraph">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;北京思博锐体育文化交流有限公司——集培训，职业发展，交流为一体，是全国第一个由国际班底组成的体育类教育机构。通过在线平台，让你随时随地都能在第一时间接受哥伦比亚大学以及行业内权威导师的授课指点。除此之外，思博锐整合独家体育类就业机遇，为会员打开职场瓶颈。在线下，思博锐定期开展赴美考察交流，让您与职业联盟高管、赛事运销高手面对面零距离接触。</div>
